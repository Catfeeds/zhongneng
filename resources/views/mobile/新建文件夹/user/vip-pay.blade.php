...
<div class="video_pay">
    <div class="payCourse">
        ...
        <div class="courseInfo">
            <p class="courseTit">VIP购买</p>
            <p class="courseDes">购买为期1年的VIP</p>
            <div class="pricesa vip">
                <p class="tag">
                    ￥
                    <span class="newPrice">{{$vip_price}}</span>
                </p>
            </div>
        </div>
    </div>
    <form method="POST" id="passwordform" action="{{URL('vip-pay-save')}}">
        @csrf
        <div class="payMethod">
            <p class="methTex">
                选择支付方式
