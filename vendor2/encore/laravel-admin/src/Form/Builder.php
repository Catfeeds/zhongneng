...
<div class="btn-group pull-left">
    <button type="submit" class="btn btn-info pull-left" data-loading-text="<i class='fa fa-spinner fa-spin '></i> $text">$text</button>
</div>
EOT;
    }
...
<div class="btn-group pull-right">
    <button type="reset" class="btn btn-warning pull-right">$text</button>
</div>
EOT;
    }
